          ...
          <div className="lg:col-span-1">
              ...
              <div className="p-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex justify-between">
                    ...
                    <p className="font-medium">${cart.tax200 overflow-hidden">
                  <img 
                    src="/src/assets/images/customer-1.jpg" 
                    alt="Customer" 
                    className="h-full w-full object-cover"
                  />
                </div>
                <div className="ml-3">
                  <p className="font-medium text-primary-800">Sarah Johnson</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-primary-700 mb-4">
                "The limited edition pieces are truly unique. Every time I wear one of their designs, I receive compliments. Worth every penny!"
              </p>
